            ...
            <Dialog fullWidth={fullWidth}  maxWidth={maxWidth} onClose={handleClose} aria-labelledby="simple-dialog-title" open={open}>
              <Paper>
                <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                  <Typography variant="h4" style={{ color: "gray" }}>Trecho da Transmissão</Typography>
                </DialogTitle>
                <MuiDialogContent style={{paddingTop:"2px"}}>
                    ...
                    <Box my={2}>
                      <Typography variant="h4">{props.data.author} ({props.data.legend}) - {(props.data.schedule).replace("horário - ", "")}</Typography>
                    </Box>
                </MuiDialogContent>
              </Paper>
            </Dialog>
